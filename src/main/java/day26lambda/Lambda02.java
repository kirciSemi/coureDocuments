...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        //removeIfElementStartWithZorEndsWithf2(myList);
        removeIfElementContainX(myList);
    ...
    //1. Yol
    public static void removeIfElementStartWithZorEndsWithf(List<String> myList){
        myList.removeIf(t-> t.startsWith("Z")||t.endsWith("f"));
        System.out.println(myList);
    }
    //2. Yol
    public static void removeIfElementStartWithZorEndsWithf2(List<String> myList){
        myList.removeIf(t-> t.charAt(0)=='Z'||t.charAt(t.length()-1)=='f');
        System.out.println(myList);
    }

    public static void removeIfElementContainX(List<String> myList){
