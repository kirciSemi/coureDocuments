...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        printElementsExceptStardsWithE(myList);
        System.out.println();
        ...
        System.out.println();
        System.out.println(getElementsLengthLessTahanFiveWithSortedLowerCase(myList));
        System.out.println();
        getElementsLengthLessTahanFiveWithSortedLowerCase1(myList);
        System.out.println();
        printElementsUniqueToUpperCaseSorted(myList);
        System.out.println();
        printElUniqueLowerCaseSortByLength(myList);

    }
    //Example 1: Bir List'teki E ile baslayanlar haric tum elemanlari
    // console'a yazdiran method'u olusturunuz.

    public static void printElementsExceptStardsWithE(List<String> myList) {
        myList.
                stream().
    ...
    public static List<String> getElementsLengthLessTahanFiveWithSortedLowerCase(List<String> myList){
       return myList.
               stream().
               distinct().
               filter(t-> t.length()<5).
    ...
    public static void getElementsLengthLessTahanFiveWithSortedLowerCase1(List<String> myList){
        myList.
                stream().
                distinct().
                filter(t-> t.length()<5).
                sorted().
                map(t-> t.toLowerCase()).forEach(t-> System.out.print(t+" "));
    }
    ...
    public static void printElUniqueLowerCaseSortByLength(List<String> myList){
        myList.
                stream().
                distinct().
                map(t-> t.toLowerCase()).
