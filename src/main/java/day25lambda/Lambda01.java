...
public class Lambda01 {
    ...
    public static void printEvenelements2(List<Integer> nums) {
        ...
        //nums.stream().filter(t-> t>=25).forEach(t-> System.out.print(t+" "));
    }
    ...
    public static void printCubeOfDistinctOddElements(List<Integer> nums) {
        nums.
                stream().
                distinct().//kolleksiyondaki tekrar eden elmanları kaldırır
                filter(t -> t % 2 != 0).
                map(t -> t * t * t).
                forEach(t -> System.out.print(t + " "));
    }
...
// "toplamını" hesaplayan method oluşturun}
    ...
    //3. yol
    //sorted() methodu listedeki değerleri natural ordera göre dizer
    public static void getMaxValue3(List<Integer> nums) {
        int max = nums.
                ...
                sorted().
                reduce((t, u) -> u).
                get();//sondaki get methodu variablelı primitive int değişken olarak gönderir
        System.out.println(max);
    }
    ...
    public static void getMaxValue4(List<Integer> nums) {
        Integer max = nums.
                stream().
                distinct().
                reduce(Math::max).//bu işleme method referance denir. Lambda da bestPractice budur.
                        get();//sondaki get methodu variablelı primitive int değişken olarak gönderir
        System.out.println(max);
    }
    ...
    public static void getMinValue(List<Integer> nums) {
        Integer min = nums.
                stream().
                distinct().
                reduce(Math::min).//bu işleme method referance denir. Lambda da bestPractice budur.
                        get();//sondaki get methodu variablelı primitive int değişken olarak gönderir
    ...
    public static void getMinValue1(List<Integer> nums) {
        Integer min = nums.
                stream().
                distinct().
                reduce((t, u) -> t > u ? u : t).//bu işleme method referance denir. Lambda da bestPractice budur.
                        get();//sondaki get methodu variablelı primitive int değişken olarak gönderir
        System.out.println(min);
    }
    ...
    public static void getMinValue2(List<Integer> nums) {
        Integer min = nums.
                stream().
                distinct().sorted(Comparator.reverseOrder()).reduce((t, u) -> u).get();
        System.out.println(min);
    }
